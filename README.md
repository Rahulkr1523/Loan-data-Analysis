...
2. Data Analysis using SQL
   - Used aggregation functions (COUNT, AVG)
   - Applied CASE statements
   - Used CTE and Window Functions

3. Data Visualization using Power BI
   - Created interactive dashboard
   - Visualized income distribution, credit history, and loan trends
...
- Graduates have higher average income than non-graduates
- Male applicants tend to take slightly higher loans
